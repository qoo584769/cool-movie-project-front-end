        ...
        <div className='row justify-content-between  p-4 gx-0 z-index-100'>
          ...
          <div className='col-12 col-md-3'>        
            <label className='d-flex align-items-center justify-content-between py-2 px-4 bd-gold'>
              ...
              <div className=''>
                <img src="@/assets/images/selectMovie.svg" alt="" className='d-block'/>
              </div>
            </label>
          </div>
          {/* 選擇影片 */}
          ...
          <div className='col-12 col-md-3'>        
            ...
            (
              <label className='d-flex align-items-center justify-content-between py-2 px-4 bd-gold'>
                ...
                <div className=''>
                  <img src="@/assets/images/selectDate.svg" alt="" className='d-block'/>
                </div>
              </label>
            )
            : 
          ...
          <div className='col-12 col-md-3'>        
            ...
            (
              <label className='d-flex align-items-center justify-content-between py-2 px-4 bd-gold'>
                ...
                <div className=''>
                  <img src="@/assets/images/selectTime.svg" alt="" className='d-block'/>
                </div>
              </label>
            )
            : 
    ...
    <header className="container-fluid bg-main pb-80">
      ...
      <div className="row justify-content-center">
        <div className="col-lg-12 col-md-6 position-relative">  
          <img src="@/assets/images/carouselImg.png" className="d-block img-fluid"></img>
            {/* <img src="@/assets/images/leftArrow.png" alt="LeftArrow" className="z-index position-absolute top-50 start-0 translate-middle-y"/> */}
            <span className="text-liner fz-40 z-index position-absolute top-50 start-50 translate-middle">奢華沉浸，非凡感官</span>
            {/* <img src="@/assets/images/rightArrow.png" alt="RightArrow" className="z-index position-absolute top-50 end-0 translate-middle-y"/> */}
        </div>
      </div>
