...
export const HomeDiscount = ()=>{
  return (    
    <div className="bg-discount">
      <img src="src/assets/images/block.png" alt="image" style={{ maxWidth: '100%' }} />
          <div className="container">
            <div className="row">
              ...
              <div className="col-12 col-md-6 text-center">
                <img src="src/assets/images/customer.png" alt="image" style={{ maxWidth: '100%', margin:'-24px 0', display:'block' }} />
              </div>
            </div>
          </div>   
          
        <img src="src/assets/images/block.png" alt="image" style={{ maxWidth: '100%','zIndex':'-100' }} />
        </div>
  )
}